...
const Card = ({ img, name, location, giveClass, index }) => {
  return (
    <div className={`relative ${giveClass || ''}`} key={index}>
      ...
      <div className="block absolute -bottom-1 lg:-bottom-1 left-0 lg:left-0 bg-white px-2 py-2 w-24 lg:w-44 rounded-r-md">

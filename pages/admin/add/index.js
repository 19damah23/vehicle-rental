      ...
      <div className="xs:container sm:container md:container lg:container xl:container mx-auto flex flex-col py-20 lg:pt-32 lg:pb-24">
        <form onSubmit={handleSubmit} encType="multipart/form-data">
          <div className="flex items-center">
            ...
            <h3 className="text-xl lg:text-4xl font-bold ml-12 lg:ml-20">
              Add new item
            </h3>
          </div>
          ...
          <div className="flex flex-col lg:flex-row justify-between mt-10 lg:mt-24">
            ...
            <div className="w-full lg:w-1/2 pl-0 lg:pl-5">
              <input
                ...
                className="border-b text-gray-400 font-light text-lg lg:text-2xl w-full py-4 focus:outline-none"
              ...
              <div className="flex flex-col mt-4">
                <label
                  htmlFor="price"
                  className="fontPlayfair font-bold text-lg lg:text-2xl mt-2"
                >
                  Price :
                </label>
                <input
                  ...
                  className="px-4 py-3 lg:py-4 rounded-md bg-gray-200 text-gray-400 text-lg lg:text-2xl focus:outline-none mt-2 lg:mt-4"
                  onChange={handleInput}
                />
              </div>
              <div className="flex flex-col mt-4">
                <Dropdown
                  ...
                  name="status"
                  id="status"
                  list={[{ title: 'available' }, { title: 'full booked' }]}
                  handleChange={handleInput}
                  titleClass="fontPlayfair font-bold text-lg lg:text-2xl mt-2"
                  classSelect="px-4 py-3 lg:py-4 rounded-md bg-gray-200 text-gray-400 text-lg lg:text-2xl focus:outline-none mt-2 lg:mt-4"
                />
              </div>
              <div className="flex justify-between items-center mt-4 lgmt-6">
                <label
                  htmlFor="stock"
                  className="fontPlayfair font-bold text-lg lg:text-2xl"
                >
                  Stock :
                </label>
                <div className="flex items-center justify-between">
                  <button
                    type="button"
                    className="px-2 py-2 w-8 h-8 bg-yellow-400 hover:bg-yellow-500 rounded-md"
                  ...
                  <span className="text-2xl font-black mx-8 lg:mx-16">
                    {stock}
                  </span>
                  <button
                    type="button"
                    className="px-2 w-8 h-8 bg-gray-300 hover:bg-gray-400 rounded-md flex items-center"
          ...
          <div className="flex justify-between mt-16">
            <div className="w-2/5 pr-2 lg:pr-4">
              <Dropdown
                ...
                id="category"
                handleChange={handleInput}
                classSelect="px-4 w-full h-12 lg:h-20 rounded-md text-white text-lg lg:text-2xl focus:outline-none bg-black font-bold"
              />
            </div>
            <div className="w-3/5 pl-2 lg:pl-4">
              <button
                className="w-full bg-yellow-400 hover:bg-yellow-500 text-2xl h-12 lg:h-20 rounded-lg font-bold"
                type="submit"
              >
                Save item
              </button>
